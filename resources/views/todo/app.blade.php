...
<head>
    ...
    <!-- Jika file bernama favicon.ico di root public -->
<link rel="icon" href="{{ asset('favicon.ico') }}" type="image/x-icon">
<!-- Jika kamu ingin pakai PNG atau dari folder lain -->
<link rel="icon" href="{{ asset('images/icons/list.png') }}" type="image/png">
